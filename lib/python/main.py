# librería que gestiona las apis
...
# se crea un objeto flask en el lugar donde estoy (en el main)
app = Flask(__name__)


# creacion de rutas
@app.route("/app/scanner")
def user_scann():  # es el controlador
    print("soy el usuairo queriendo acceder al servicio de scann remoto")
    print("Empezando serivicio en la pc:")
    ...
    return str(results.multi_face_landmarks)


# indica en qué puerto se va a correr nuestra api (como no especificamos, se nos pone por default)
# inicia la aplicación en modo debug porque está en desarrollo
# el numero después de los dos puntos es el puerto que me asignaron
# soiempre la final para que se ejecute el servidor
app.run(debug=True)
